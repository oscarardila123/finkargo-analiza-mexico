...
const mockCompetitors: Competitor[] = [
  {
    id: "1",
    name: "Tech Solutions Colombia SAS",
    nit: "900.123.456-1",
    marketShare: 18.5,
    totalImports: 2450000,
    avgMonthlyImports: 204000,
    topSuppliers: ["Shenzhen Electronics Co.", "Samsung Electronics", "Intel Corp"],
    topProducts: ["Semiconductores", "Componentes electrónicos", "Microprocesadores"],
    growthRate: 12.5,
    riskLevel: 'high',
  ...
  {
    id: "2",
    name: "Digital Components Ltda",
    nit: "800.987.654-2",
    marketShare: 15.2,
    totalImports: 1890000,
    avgMonthlyImports: 157500,
    topSuppliers: ["Taiwan Semiconductor", "European Tech GmbH", "Asian Electronics"],
    topProducts: ["Circuitos integrados", "Memoria RAM", "Procesadores"],
    growthRate: 8.7,
    riskLevel: 'medium',
  ...
  },
  {
    ...
    topSuppliers: ["China Electronics Ltd", "Korean Tech Co", "German Components"],
    topProducts: ["Dispositivos móviles", "Componentes de red", "Accesorios"],
    growthRate: -3.2,
    riskLevel: 'low',
  ...
  {
    id: "4",
    name: "Electronics Pro Colombia",
    nit: "600.111.222-4",
    marketShare: 10.3,
    totalImports: 1320000,
    avgMonthlyImports: 110000,
    topSuppliers: ["Japanese Electronics", "US Components Inc", "Nordic Tech"],
    topProducts: ["Sensores", "Componentes IoT", "Microcontroladores"],
    growthRate: 22.1,
    riskLevel: 'high',
