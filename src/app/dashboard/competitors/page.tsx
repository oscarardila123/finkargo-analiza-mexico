...
const mockCompetitors: Competitor[] = [
  ...
  {
    id: "2",
    name: "SSANGYONG MOTOR COLOMBIA SA",
    nit: "900.567.123-4",
    marketShare: 15.2,
    totalImports: 1890000,
    avgMonthlyImports: 157500,
    topSuppliers: ["SsangYong Motor", "Hyundai Motor", "Kia Motors"],
    topProducts: ["Vehículos SUV", "Repuestos Ssangyong", "Componentes automotrices"],
    growthRate: 8.7,
    riskLevel: 'medium',
